...
!function (t, e) {
  if ("object" == ( false ? 0 : _typeof(exports)) && "object" == ( false ? 0 : _typeof(module))) module.exports = e();else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
  ...
  return function () {
    var t = {
          ...
          t.exports = function (t) {
            ...
            return e.toString = function () {
              ...
              for (var r = 0; r < t.length; r++) {
                var l = [].concat(t[r]);
                s && a[l[0]] || (i && (l[2] ? l[2] = "".concat(i, " and ").concat(l[2]) : l[2] = i), e.push(l));
              }
            }, e;
          };
        },
        ...
        93379: function _(t, e, i) {
          ...
          function m(t, e, i, s) {
            ...
            if (t.styleSheet) t.styleSheet.cssText = d(e, a);else {
          ...
          function h(t, e, i) {
            var s = i.css,
              a = i.media,
              n = i.sourceMap;
            if (a ? t.setAttribute("media", a) : t.removeAttribute("media"), n && "undefined" != typeof btoa && (s += "\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(n)))), " */")), t.styleSheet) t.styleSheet.cssText = s;else {
          ...
          function v(t, e) {
            ...
            if (e.singleton) {
              var n = y++;
              i = p || (p = c(e)), s = m.bind(null, i, n, !1), a = m.bind(null, i, n, !0);
            } else i = c(e), s = h.bind(null, i, e), a = function a() {
              !function (t) {
    ...
    return function () {
      ...
      i.r(s), i.d(s, {
        TemplateCustomizer: function TemplateCustomizer() {
          return w;
        }
      });
      var t = i(93379),
      ...
      function c(t, e) {
        for (var i = 0; i < e.length; i++) {
          var s = e[i];
          s.enumerable = s.enumerable || !1, s.configurable = !0, "value" in s && (s.writable = !0), Object.defineProperty(t, u(s.key), s);
        }
      }
      function u(t) {
        var e = function (t, e) {
      ...
      var v = document.getElementsByTagName("HTML")[0].getAttribute("data-theme") || 0,
        ...
        w = function () {
            ...
            value: function value(t) {
              ...
              if (this._hasControls("themes")) {
                ...
                if (s) {
                  ...
                  this._loadStylesheets((a = {}, n = r, o = document.querySelector(".template-customizer-theme-css"), (n = u(n)) in a ? Object.defineProperty(a, n, {
                    value: o,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
            ...
            value: function value() {
              ...
              if (this._hasControls("rtl headerType contentLayout layoutCollapsed layoutNavbarOptions", !0)) {
                ...
                if (this._hasControls("rtl") && rtlSupport) {
                  ...
                  S.addEventListener("change", z), this._listeners.push([S, "change", z]);
          ...
          }], i && c(e.prototype, i), s && c(e, s), Object.defineProperty(e, "prototype", {
            writable: !1
          }), t;
        }();
      w.STYLES = [{
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/assets/vendor/js/template-customizer.js");
/******/ 	
